...
interface TaskDao {
    ...
    @Query("SELECT * FROM USER, TASK WHERE USER.id_User = TASK.id_User AND USER.id_User =:id AND TASK.status_task = :status")
    fun getTaskbyStatus(id:Int, status:String): LiveData<List<Task>>
